...
DEEPFRAME_CXX?=/usr/bin/g++ # Make seems to define its own CXX, so we use custom
CXX=$(DEEPFRAME_CXX) # This is the main compiler
...
LIB=-llog4cpp -lgtest -lcurand -lcublas #-pthread
INC= #-Iinclude
TESTINC=-Isrc/main
